...
const styles = StyleSheet.create({
  ...
  avatarLarge: { width: 100, height: 100, borderRadius: 30, backgroundColor: COLORS.arenaBlue, justifyContent: 'center', alignItems: 'center', marginBottom: SPACING.md, shadowColor: COLORS.arenaBlue, shadowOpacity: 0.3, shadowRadius: 20, elevation: 10 },
